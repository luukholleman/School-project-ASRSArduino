...
void ColorSensor::read_sensor()
{
    ...
    {
        raw_values[BLANK_INDEX] = read_full_color_value(1);
        raw_values[RED_INDEX] = read_full_color_value(0);
        raw_values[GREEN_INDEX] = read_full_color_value(1);
        raw_values[BLUE_INDEX] = read_full_color_value(0);
    }
    else
    {
...
{
    int cal_tab;
    int blank_val = raw_values[BLANK_INDEX];
	...
	if (blank_val > MINBLANKVAL)
        ...
        cal_values[BLANK_INDEX] = (blank_val * calData[cal_tab][BLANK_INDEX]) >> 16 ; //TODO CHECK SHIFT
...
{
    int red = cal_values[RED_INDEX];
    int blue = cal_values[BLUE_INDEX];
    int green = cal_values[GREEN_INDEX];
    int blank = cal_values[BLANK_INDEX];
